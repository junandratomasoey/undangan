<section class="px-6 py-24">
    <div class="mx-auto max-w-3xl">
        <header class="reveal text-center">
            <p class="font-sans text-[10px] uppercase tracking-widest2 text-gold">Lokasi</p>
            <h2 class="mt-2 font-display text-4xl text-emerald2-deep">{{ $event->venue_name }}</h2>
        </header>
        <div class="reveal mt-10 overflow-hidden border border-emerald2/30 shadow-sm">
