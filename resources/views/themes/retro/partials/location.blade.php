<section class="px-6 py-24">
    <div class="mx-auto max-w-3xl">
        <header class="reveal text-center">
            <p class="font-sans text-[10px] font-bold uppercase tracking-widest2 text-rust">Lokasi</p>
            <h2 class="mt-2 font-display text-4xl uppercase text-cocoa">{{ $event->venue_name }}</h2>
        </header>
        <div class="reveal mt-10 overflow-hidden rounded-3xl border-4 border-cocoa">
