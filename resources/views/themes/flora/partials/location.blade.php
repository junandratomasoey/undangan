<section class="px-6 py-24">
    <div class="mx-auto max-w-3xl">
        <header class="reveal text-center">
            <p class="font-sans text-[10px] uppercase tracking-widest2 text-sage-deep">Lokasi Acara</p>
            <h2 class="mt-2 font-script text-4xl text-sage-dark">{{ $event->venue_name }}</h2>
        </header>
        <div class="reveal mt-10 overflow-hidden rounded-3xl border-2 border-sage/30 shadow-sm">
