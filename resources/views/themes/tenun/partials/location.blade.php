<section class="px-6 py-24">
    <div class="mx-auto max-w-3xl">
        <header class="reveal text-center">
            <p class="font-sans text-xs uppercase tracking-[0.25em] text-ink/50">Lokasi Acara</p>
            <h2 class="mt-2 font-display text-4xl text-maroon">{{ $event->venue_name }}</h2>
        </header>
        <div class="reveal mt-10 overflow-hidden border-2 border-ochre/40">
